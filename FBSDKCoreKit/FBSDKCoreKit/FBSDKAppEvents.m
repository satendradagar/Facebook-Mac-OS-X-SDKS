...
//    UIViewController *vc = [UIApplication sharedApplication].keyWindow.contentViewController.presentedViewController;
//    if (vc) {
...
//  } else {
  //SS TODO://
    currentViewControllerName = @"off_thread-Mac OS";
//  }
